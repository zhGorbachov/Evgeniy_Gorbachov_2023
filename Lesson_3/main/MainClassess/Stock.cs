...
{
    public static List<MotherBoard> MotherBoardsShop = new List<MotherBoard>
    {
    ...
    public static List<Cpu> CpusShop = new List<Cpu>
    {
    ...
    public static List<Gpu> GpusShop = new List<Gpu>
    {
    ...
    public static List<Ram> RamsShop = new List<Ram>
    {
    ...
    public static List<Drive> DrivesShop = new List<Drive>
    {
